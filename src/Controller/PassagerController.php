...
final class PassagerController extends AbstractController
{
    ...
    #[Route('/home', name: 'app_passager_home', methods: ['GET'])]
    public function home(): Response
    {
        return $this->render('passager/home.html.twig');
    }
    ...
    public function new(Request $request, UserPasswordHasherInterface $userPasswordHasher, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $passager->setRoles(["ROLE_PASSAGER"]); // Si nécessaire, ajouter un rôle spécifique
